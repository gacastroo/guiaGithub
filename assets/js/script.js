...
═══════════════════════════════ */
  ...
  "Esencial": "Essential",
  "Recomendado": "Recommended",
  "Estos son algunos de los comandos básicos de git y los que posiblemente mas utilices, espero que te ayuden :D Haz clic en cualquier comando para copiarlo al portapapeles.": "These are some basic Git commands and probably the ones you will use most. I hope they help :D Click any command to copy it to the clipboard.",
  "1 · Configuración inicial": "1 · Initial setup",
  "Una vez que has instalado Git, es recomendable configurar tu nombre de usuario y correo electrónico:": "Once Git is installed, it is recommended to configure your username and email address:",
  "⚠️ Sin esto no te permitirá hacer commits.": "⚠️ Without this, Git will not let you make commits.",
  "Configura tu nombre de usuario": "Sets your username",
  "Copiar": "Copy",
  "Configura tu correo electrónico": "Sets your email address",
  "2 · Iniciar un proyecto": "2 · Start a project",
  "Estos son los cambios que necesitas hacer para iniciar un proyecto con Git:": "These are the commands you need to start a project with Git:",
  "Crea un repositorio nuevo en la carpeta actual": "Creates a new repository in the current folder",
  "Crea una nueva conexión a un repositorio remoto.": "Creates a new connection to a remote repository.",
  "Descarga un repositorio existente": "Downloads an existing repository",
  "Descarga los cambios del repositorio remoto": "Downloads changes from the remote repository",
  ...
  "Baja los cambios del remoto": "Pulls changes from the remote",
  "4 · Ramas": "4 · Branches",
  "Estos son los comandos que usas para trabajar con ramas:": "These are the commands you use to work with branches:",
  "Crea y cambia a una rama nueva": "Creates and switches to a new branch",
  "Vuelve a la rama principal": "Switches back to the main branch",
  "Une la rama con la actual": "Merges the branch into the current one",
  "⚠️ Un merge puede causar conflictos si los cambios en ambas ramas son incompatibles. Cuando haces un merge, no hay forma de deshacerlo una vez que se resuelven los conflictos.": "⚠️ A merge can cause conflicts if the changes in both branches are incompatible. Once a merge is completed and conflicts are resolved, it cannot be easily undone.",
  "5 · Si algo va mal": "5 · If something goes wrong",
  "Ver historial de commits resumido": "View a summarized commit history",
  "Descartar cambios en un archivo": "Discard changes in a file",
  "Quitar un archivo del staging": "Remove a file from staging",
  "Git guarda tu trabajo en dos pasos: preparar y guardar. Cuando cambias archivos, Git ve esos cambios, pero no los guarda directamente. Primero eliges qué cambios quieres incluir (eso es staging o preparar). Luego los guardas con un commit. Es como hacer una foto: primero eliges qué quieres que salga en la foto (preparar) y luego haces la foto (guardar).": "Git saves your work in two steps: stage and save. When you change files, Git sees those changes, but it does not save them directly. First you choose which changes to include (that is staging). Then you save them with a commit. It is like taking a photo: first you choose what should appear in the photo, and then you take the photo.",
  "Repositorio Local: Es la carpeta en tu ordenador. Es donde editas tus archivos día a día. GitHub no ve esto hasta que tú lo envías.": "Local Repository: This is the folder on your computer. It is where you edit your files day to day. GitHub does not see it until you send it.",
  "Repositorio Remoto: Es la copia en los servidores de GitHub. Es tu respaldo en la nube y el lugar donde los demás ven tu código.": "Remote Repository: This is the copy on GitHub's servers. It is your cloud backup and the place where others can see your code.",
  "1": "1",
  "2": "2",
  ...
  "Ve a la carpeta donde quieres guardar el proyecto, por ejemplo:": "Go to the folder where you want to save the project, for example:",
  "Después, ejecuta el comando git clone :": "Then run the git clone command:",
  "Entra dentro de la carpeta que se acaba de descargar:": "Go into the folder that was just downloaded:",
  "Al clonar un repositorio, Git crea automáticamente la conexión con GitHub. Esa conexión se llama normalmente origin .": "When you clone a repository, Git automatically creates the connection with GitHub. That connection is usually called origin.",
  "Puedes comprobarlo con:": "You can check it with:",
  "Si todo está correcto, verás algo parecido a esto:": "If everything is correct, you will see something like this:",
  "Usa esta opción si ya tienes tu proyecto creado en tu computadora y quieres conectarlo con un repositorio nuevo de GitHub.": "Use this option if you already have your project created on your computer and want to connect it to a new GitHub repository.",
  ...
  "Ahora ejecuta estos comandos en orden:": "Now run these commands in order:",
  "¿Qué hace cada comando?": "What does each command do?",
  "git init : convierte tu carpeta en un repositorio local.": "git init: turns your folder into a local repository.",
  "git add . : prepara todos los archivos para guardarlos.": "git add .: stages all files so they can be saved.",
  "git commit -m \"feat: initial commit\" : crea el primer punto de guardado.": "git commit -m \"feat: initial commit\": creates the first save point.",
  "git branch -M main : asegura que la rama principal se llame main .": "git branch -M main: makes sure the main branch is called main.",
  "git remote add origin : conecta tu repositorio local con el repositorio remoto de GitHub.": "git remote add origin: connects your local repository to the remote GitHub repository.",
  "git push -u origin main : sube tu proyecto a GitHub y deja la rama conectada para futuros pushes.": "git push -u origin main: uploads your project to GitHub and keeps the branch connected for future pushes.",
  "Resumen fácil: git clone descarga un proyecto que ya existe en GitHub. git remote add origin conecta una carpeta local con un repositorio remoto.": "Simple summary: git clone downloads a project that already exists on GitHub. git remote add origin connects a local folder to a remote repository.",
  "Después de hacer esto una vez, tu flujo diario será:": "After doing this once, your daily workflow will be:",
  "Nota: sustituye usuario y nombre-repositorio por los datos reales de tu cuenta y de tu repositorio.": "Note: replace usuario and nombre-repositorio with the real details of your account and repository.",
  "Vincular GitHub con VS Code:": "Link GitHub with VS Code:",
  ...
  "git switch main && git merge feature/mi-nueva-funcionalidad": "git switch main && git merge feature/my-new-feature",
  "Crear y navegar": "Create and navigate",
  "Crea una rama nueva y cambia a ella directamente": "Creates a new branch and switches to it directly",
  "Cambia a una rama ya existente": "Switches to an existing branch",
  "Lista todas las ramas locales (la activa aparece con *)": "Lists all local branches (the active one appears with *)",
  ...
  "Los commits de la rama fusionada quedan integrados permanentemente en la rama destino.": "The commits from the merged branch become permanently integrated into the target branch.",
  "Puede generar conflictos de merge si ambas ramas modificaron las mismas líneas. Tendrás que resolverlos manualmente antes de continuar.": "It can create merge conflicts if both branches modified the same lines. You will have to resolve them manually before continuing.",
  "Una vez resueltos los conflictos y confirmado el merge, no se puede deshacer fácilmente (requiere git revert o git reset con cuidado).": "Once conflicts are resolved and the merge is confirmed, it cannot be easily undone (it requires git revert or careful use of git reset).",
  "En proyectos compartidos, un merge directo sin Pull Request puede saltarse la revisión del equipo.": "In shared projects, a direct merge without a Pull Request can bypass team review.",
  "Asegúrate de estar en la rama correcta antes de ejecutarlo ( git branch para comprobarlo).": "Make sure you are on the correct branch before running it (use git branch to check).",
  "Elimina una rama local (solo si ya fue fusionada)": "Deletes a local branch (only if it has already been merged)",
  "Consecuencias de eliminar una rama local": "Consequences of deleting a local branch",
  "git branch -d solo borra la rama si ya fue fusionada, lo cual es una protección. Pero git branch -D (mayúscula) la elimina aunque tenga commits sin fusionar , perdiendo esos cambios.": "git branch -d only deletes the branch if it has already been merged, which is a protection. But git branch -D (uppercase) deletes it even if it has unmerged commits, losing those changes.",
  "Una vez eliminada la rama local sin haber hecho push, los commits exclusivos de esa rama se pierden .": "Once a local branch is deleted without having been pushed, the commits that existed only on that branch are lost.",
  "Si otro compañero tenía esa rama como referencia, deberá actualizar su repositorio local.": "If another teammate had that branch as a reference, they will need to update their local repository.",
  "Elimina la rama también del repositorio remoto": "Deletes the branch from the remote repository too",
  "Consecuencias de eliminar una rama remota": "Consequences of deleting a remote branch",
  "La rama desaparece del repositorio remoto para todos los colaboradores del proyecto.": "The branch disappears from the remote repository for all project collaborators.",
  "Cualquier Pull Request abierto basado en esa rama quedará automáticamente cerrado o huérfano .": "Any open Pull Request based on that branch will be automatically closed or orphaned.",
  "Los compañeros que tengan la rama en local recibirán errores al hacer git fetch o git pull si intentan actualizarla.": "Teammates who have the branch locally will get errors when running git fetch or git pull if they try to update it.",
  "La acción no tiene confirmación previa : se ejecuta de inmediato. Confirma bien el nombre antes de lanzar el comando.": "This action has no confirmation prompt: it runs immediately. Double-check the name before running the command.",
  "Sube tu rama con git push origin nombre-rama": "Push your branch with git push origin branch-name",
  "En GitHub, aparece un botón \"Compare & pull request\" — haz clic": "On GitHub, a \"Compare & pull request\" button appears — click it",
  "Escribe una descripción de qué cambios hiciste y por qué": "Write a description of what changes you made and why",
  "Tus compañeros revisan, comentan y aprueban (o piden cambios)": "Your teammates review, comment and approve (or request changes)",
  "Cuando todo está bien, se hace clic en \"Merge pull request\" ✅": "When everything is OK, click \"Merge pull request\" ✅",
  "Git marcará el conflicto así en el archivo:": "Git will mark the conflict like this in the file:",
  "\"Imagina que tú y un compañero editáis el mismo párrafo de un documento compartido al mismo tiempo. Cuando intentáis unir los cambios, alguien tiene que decidir qué versión queda. Eso es exactamente un conflicto de merge.\"": "\"Imagine you and a teammate edit the same paragraph of a shared document at the same time. When you try to merge the changes, someone has to decide which version remains. That is exactly a merge conflict.\"",
  ...
  "# Git no sabe qué línea elegir y marca el conflicto así:": "# Git does not know which line to choose and marks the conflict like this:",
  "<<<<<<< HEAD": "<<<<<<< HEAD",
  "=======": "=======",
  ">>>>>>> feature/traduccion": ">>>>>>> feature/translation",
  "Clave: Git no elimina tu código. Lo marca con señales para que tú decidas qué versión queda. Los marcadores <<< , === y >>> son temporales; desaparecen una vez que resuelves el conflicto.": "Key point: Git does not delete your code. It marks it with signs so you can decide which version remains. The <<<, === and >>> markers are temporary; they disappear once you resolve the conflict.",
  "Marcador": "Marker",
  "Qué significa": "What it means",
  "Inicio del bloque de tu rama actual (la rama en la que estás).": "Start of the block from your current branch (the branch you are on).",
  "Separador entre las dos versiones. Lo que hay arriba es tuyo; lo que hay abajo viene de la otra rama.": "Separator between the two versions. What is above is yours; what is below comes from the other branch.",
  ">>>>>>> feature/nombre": ">>>>>>> feature/name",
  "Fin del bloque de la rama que estás fusionando .": "End of the block from the branch you are merging.",
  "Estos son los conflictos que encontrarás con más frecuencia en proyectos reales.": "These are the conflicts you will find most often in real projects.",
  "Escenario 1 · Texto cambiado en la misma línea": "Scenario 1 · Text changed on the same line",
  "El caso más común. Dos personas editan el mensaje de un mismo botón o la misma variable de configuración.": "The most common case. Two people edit the text of the same button or the same configuration variable.",
  "Solución: elige uno de los dos valores (o escribe uno nuevo), borra los tres marcadores y guarda.": "Solution: choose one of the two values (or write a new one), delete the three markers and save.",
  "Escenario 2 · Función modificada de forma distinta": "Scenario 2 · Function modified in different ways",
  "Una persona añade validación a una función; otra la refactoriza al mismo tiempo.": "One person adds validation to a function; another refactors it at the same time.",
  "Solución: en este caso lo correcto probablemente es combinar ambos cambios manualmente:": "Solution: in this case, the right thing is probably to combine both changes manually:",
  "Escenario 3 · Archivo eliminado vs. modificado": "Scenario 3 · File deleted vs. modified",
  "Una rama elimina un archivo que la otra ha modificado. Git no sabe si debes conservarlo o borrarlo.": "One branch deletes a file that the other branch modified. Git does not know whether you should keep it or delete it.",
  "Solución: decide explícitamente si el archivo debe existir o no:": "Solution: explicitly decide whether the file should exist or not:",
  "Git te avisa del conflicto": "Git warns you about the conflict",
  "Al hacer git merge o git pull , Git lista los archivos en conflicto.": "When running git merge or git pull, Git lists the conflicted files.",
  "CONFLICT (content): Merge conflict in src/saludo.js Automatic merge failed; fix conflicts and then commit the result.": "CONFLICT (content): Merge conflict in src/hello.js Automatic merge failed; fix conflicts and then commit the result.",
  "Localiza los archivos afectados": "Locate the affected files",
  "Usa git status para ver qué archivos tienen conflictos pendientes.": "Use git status to see which files still have pending conflicts.",
  "git status": "git status",
  "Abre el archivo y edítalo": "Open the file and edit it",
  "Busca los marcadores <<< , === y >>> . Decide qué versión conservar (o combina las dos). Borra todos los marcadores. Guarda el archivo.": "Look for the <<<, === and >>> markers. Decide which version to keep (or combine both). Delete all markers. Save the file.",
  "Marca el archivo como resuelto y haz commit": "Mark the file as resolved and commit",
  "Una vez editado, añade el archivo al stage y cierra el merge con un commit.": "Once edited, add the file to the stage and close the merge with a commit.",
  "git add src/saludo.js git commit -m \"fix: resolver conflicto en saludo.js\"": "git add src/hello.js git commit -m \"fix: resolve conflict in hello.js\"",
  "¿Te has liado? Puedes abortar el merge": "Got stuck? You can abort the merge",
  "Si en medio de la resolución te das cuenta de que algo no cuadra, puedes cancelar el merge y volver al estado anterior como si nada hubiera ocurrido:": "If, while resolving the conflict, you realize something is wrong, you can cancel the merge and return to the previous state as if nothing had happened:",
  "Los conflictos no se pueden eliminar del todo, pero sí reducir con buenos hábitos de equipo:": "Conflicts cannot be completely eliminated, but they can be reduced with good team habits:",
  "Actualiza tu rama antes de empezar a trabajar. Haz git pull origin main cada mañana para partir siempre del código más reciente.": "Update your branch before you start working. Run git pull origin main every morning so you always start from the latest code.",
  "Ramas pequeñas y de corta duración. Cuanto más tiempo vive una rama sin fusionarse, más diverge de main y más conflictos acumula.": "Small, short-lived branches. The longer a branch lives without being merged, the more it diverges from main and the more conflicts it accumulates.",
  "Comunica qué archivos estás tocando. En equipo, avisad cuando vais a modificar archivos de configuración compartida como .env.example , package.json o archivos de rutas.": "Communicate which files you are touching. In a team, let others know when you are going to modify shared configuration files such as .env.example, package.json or route files.",
  "Haz merge frecuente de main en tu rama. En lugar de esperar al final, trae los cambios de main a tu rama periódicamente: git switch mi-rama git merge main": "Merge main into your branch frequently. Instead of waiting until the end, bring changes from main into your branch periodically: git switch my-branch git merge main",
  "Usa Pull Requests con revisión. El proceso de PR detecta posibles conflictos antes de fusionar y permite que alguien más revise los cambios.": "Use Pull Requests with review. The PR process detects possible conflicts before merging and allows someone else to review the changes.",
  "\"Un conflicto que se resuelve el mismo día en que aparece es un problema de 2 minutos. Un conflicto acumulado durante dos semanas puede ser un problema de dos horas.\"": "\"A conflict resolved the same day it appears is a 2-minute problem. A conflict accumulated for two weeks can become a two-hour problem.\"",
  "Patrón": "Pattern",
  "Significado": "Meaning",
  ...
  "Contiene todas las dependencias del proyecto. Pueden pesar cientos de MB y se reinstalan fácilmente con npm install .": "Contains all project dependencies. They can weigh hundreds of MB and are easily reinstalled with npm install.",
  "npm-debug.log* yarn-debug.log*": "npm-debug.log* yarn-debug.log*",
  "Logs generados automáticamente cuando ocurre un error durante la instalación. Son locales y no aportan nada al repositorio.": "Logs generated automatically when an error occurs during installation. They are local and add nothing to the repository.",
  "Contiene variables de entorno sensibles: claves de API, credenciales de bases de datos, contraseñas. Subirlo supone un grave riesgo de seguridad.": "Contains sensitive environment variables: API keys, database credentials and passwords. Uploading it is a serious security risk.",
  "dist/ / build/": "dist/ / build/",
  "Carpetas generadas por el proceso de compilación o transpilación (Webpack, Vite…). Se regeneran a partir del código fuente, no tiene sentido versionar su contenido.": "Folders generated by the compilation or transpilation process (Webpack, Vite…). They are regenerated from source code, so versioning their contents makes no sense.",
  "Python": "Python",
  "__pycache__/": "__pycache__/",
  "Carpeta que Python genera automáticamente para almacenar módulos en caché y acelerar su carga. Es específica de cada máquina y sistema operativo.": "Folder automatically generated by Python to store cached modules and speed up loading. It is specific to each machine and operating system.",
  "*.pyc": "*.pyc",
  "Archivos de bytecode generados al interpretar los .py . No son código fuente y varían entre versiones de Python y entre sistemas.": "Bytecode files generated when interpreting .py files. They are not source code and vary between Python versions and systems.",
  "Contiene variables de entorno sensibles que nunca deben compartirse públicamente.": "Contains sensitive environment variables that should never be shared publicly.",
  "venv/": "venv/",
  ...
  "Java": "Java",
  "target/": "target/",
  "Carpeta donde Maven o Gradle depositan todos los archivos generados durante la compilación. Se regenera completamente al construir el proyecto.": "Folder where Maven or Gradle places all files generated during compilation. It is completely regenerated when building the project.",
  "*.class": "*.class",
  "Bytecode compilado por javac a partir del código fuente .java . Es específico de la máquina virtual y se regenera en cada compilación.": "Bytecode compiled by javac from .java source code. It is specific to the virtual machine and is regenerated on every compilation.",
  "*.jar": "*.jar",
  "Artefacto empaquetado con el código compilado y sus dependencias. Es la salida del build, no código fuente. Se regenera con mvn package o gradle build .": "Packaged artifact with compiled code and its dependencies. It is build output, not source code. It is regenerated with mvn package or gradle build.",
  "*.war": "*.war",
  "Similar al .jar pero para aplicaciones web Java desplegadas en servidores como Tomcat. También es un artefacto de build, no fuente.": "Similar to .jar, but for Java web applications deployed on servers such as Tomcat. It is also a build artifact, not source.",
  "Registros de ejecución generados localmente durante pruebas o el servidor. Son específicos de cada entorno y no aportan valor al repositorio.": "Execution logs generated locally during tests or server runs. They are environment-specific and add no value to the repository.",
  "PHP": "PHP",
  "vendor/": "vendor/",
  "Carpeta donde Composer instala todas las dependencias. Puede ser muy pesada y se restaura completamente ejecutando composer install a partir del composer.lock .": "Folder where Composer installs all dependencies. It can be very large and is fully restored by running composer install from composer.lock.",
  "Archivos de log generados por el servidor web (Apache, Nginx) o el framework (Laravel, Symfony). Son locales y no deben versionarse.": "Log files generated by the web server (Apache, Nginx) or the framework (Laravel, Symfony). They are local and should not be versioned.",
  "Contiene configuración sensible del entorno: credenciales de base de datos, claves de cifrado, tokens de servicios externos. Nunca debe subirse al repositorio.": "Contains sensitive environment configuration: database credentials, encryption keys and external service tokens. It must never be uploaded to the repository.",
  "Pon a prueba lo que has aprendido. Una pregunta a la vez.": "Test what you have learned. One question at a time.",
  "Pregunta 1 de 10": "Question 1 of 10",
  "← Anterior": "← Previous",
  "Confirmar": "Confirm",
  "Siguiente →": "Next →",
  "Practica los comandos reales de Git en un terminal simulado. Completa los 5 retos para ganar.": "Practice real Git commands in a simulated terminal. Complete the 5 challenges to win.",
  "Tienes un proyecto Node.js. Escribe las reglas correctas en el .gitignore para que solo queden los archivos de código fuente. Observa cómo cambia el estado de cada archivo en tiempo real.": "You have a Node.js project. Write the correct .gitignore rules so only source code files remain. Watch how each file's status changes in real time.",
  "0 de 6 archivos ignorados correctamente": "0 of 6 files ignored correctly",
  "📁 Archivos del proyecto": "📁 Project files",
  "📄 .gitignore": "📄 .gitignore",
  "# escribe tus reglas aquí, una por línea": "# write your rules here, one per line",
  ...
  "¿Por qué estas reglas?": "Why these rules?",
  "Carpeta de dependencias. Puede pesar cientos de MB y se reinstala con npm install .": "Dependencies folder. It can weigh hundreds of MB and is reinstalled with npm install.",
  "Salida del build (Webpack, Vite…). Se regenera a partir del código fuente.": "Build output (Webpack, Vite…). It is regenerated from source code.",
  "Variables de entorno sensibles: claves API, credenciales. Nunca debe subirse.": "Sensitive environment variables: API keys, credentials. It must never be uploaded.",
  ".env.local": ".env.local",
  "Variante local del .env, igualmente sensible y específica de cada máquina.": "Local variant of .env, equally sensitive and specific to each machine.",
  "Comodín que ignora todos los archivos .log. Son registros locales de ejecución.": "Wildcard that ignores all .log files. They are local execution logs.",
  ".DS_Store": ".DS_Store",
  "Metadatos internos de macOS. No aportan nada al repositorio.": "Internal macOS metadata. It adds nothing to the repository.",
  "Practica un caso real: dos ramas modifican la misma línea de index.html . Tendrás que provocar el conflicto, resolverlo y finalizar el merge.": "Practice a real case: two branches modify the same line in index.html. You will trigger the conflict, resolve it and finish the merge.",
  "Paso 1 de 6": "Step 1 of 6",
  "🌿 Estado del repositorio": "🌿 Repository status",
  "📄 index.html": "📄 index.html",
  "Cuando Git marque el conflicto, elimina los marcadores <<<<<<< , ======= y >>>>>>> .": "When Git marks the conflict, remove the <<<<<<<, ======= and >>>>>>> markers.",
  "Comprobar resolución ✓": "Check resolution ✓",
  "¿Qué significan los marcadores del conflicto?": "What do the conflict markers mean?",
  "Es la versión de la rama actual. En este caso, la versión que había en main .": "This is the version from the current branch. In this case, the version that was on main.",
  "Separa las dos versiones que Git no sabe combinar automáticamente.": "Separates the two versions that Git cannot combine automatically.",
  ">>>>>>> feature-titulo": ">>>>>>> feature-title",
  "Es la versión que viene desde la rama que estás fusionando.": "This is the version coming from the branch you are merging.",
  "git add index.html": "git add index.html",
  "Marca el archivo como resuelto después de limpiarlo.": "Marks the file as resolved after cleaning it.",
  "git commit": "git commit",
  "Finaliza el merge y guarda la resolución del conflicto.": "Finishes the merge and saves the conflict resolution.",
  "Vista general de la integración de Git en VS Code": "Overview of Git integration in VS Code",
  "Cuando editas un archivo, VS Code lo marca automáticamente en el explorador de archivos con una letra:": "When you edit a file, VS Code automatically marks it in the file explorer with a letter:",
  "M (Modified) — archivo modificado.": "M (Modified) — modified file.",
  "U (Untracked) — archivo nuevo que Git aún no conoce.": "U (Untracked) — new file that Git does not know yet.",
  ...
  "En el panel Source Control verás los mismos archivos agrupados en dos secciones: Changes (cambios sin preparar) y Staged Changes (cambios listos para el commit).": "In the Source Control panel, you will see the same files grouped into two sections: Changes (unstaged changes) and Staged Changes (changes ready for commit).",
  "El panel Source Control lista todos los archivos con cambios pendientes": "The Source Control panel lists all files with pending changes",
  "Antes de hacer un commit debes preparar los archivos que quieres incluir. En VS Code tienes dos formas de hacerlo:": "Before making a commit, you must stage the files you want to include. In VS Code there are two ways to do it:",
  "Haz clic en el icono + que aparece al pasar el ratón por encima de un archivo en la sección Changes para añadirlo individualmente.": "Click the + icon that appears when hovering over a file in the Changes section to add it individually.",
  "Haz clic en el + junto al encabezado Changes para preparar todos los archivos a la vez.": "Click the + next to the Changes heading to stage all files at once.",
  "Los archivos preparados se moverán a la sección Staged Changes . Si cambias de opinión, haz clic en el icono − para retirarlos del stage.": "Staged files will move to the Staged Changes section. If you change your mind, click the − icon to remove them from the stage.",
  "Haz clic en + para mover un archivo a Staged Changes": "Click + to move a file to Staged Changes",
  "Una vez preparados los archivos, escribe un mensaje descriptivo en el campo de texto que dice \"Message (Ctrl+Enter to commit)\" y pulsa Ctrl+Enter (o haz clic en el botón Commit ✔ ). El commit quedará registrado en el historial local de tu repositorio.": "Once the files are staged, write a descriptive message in the text field that says \"Message (Ctrl+Enter to commit)\" and press Ctrl+Enter (or click the Commit ✔ button). The commit will be recorded in your local repository history.",
  "Consejo: Un buen mensaje de commit responde a la pregunta \"¿Qué hace este cambio?\", por ejemplo: Añade formulario de contacto .": "Tip: A good commit message answers the question \"What does this change do?\", for example: Add contact form.",
  "Escribe el mensaje y pulsa Ctrl+Enter para confirmar el commit": "Write the message and press Ctrl+Enter to confirm the commit",
  "En la esquina inferior izquierda de VS Code verás el nombre de la rama actual (normalmente main o master ). Haz clic sobre él para abrir el menú de ramas y selecciona Create new branch… . Escribe el nombre de tu nueva rama (por ejemplo, feature/formulario-contacto ) y pulsa Enter .": "In the lower-left corner of VS Code, you will see the name of the current branch (usually main or master). Click it to open the branch menu and select Create new branch…. Type the name of your new branch (for example, feature/contact-form) and press Enter.",
  "VS Code creará la rama y cambiará a ella automáticamente. Todos los commits que hagas a partir de ahora irán a esta rama sin afectar a main .": "VS Code will create the branch and switch to it automatically. All commits you make from now on will go to this branch without affecting main.",
  "Haz clic en el nombre de la rama (barra inferior) para ver todas las opciones de rama": "Click the branch name (bottom bar) to see all branch options",
  "Desde el mismo menú de la barra de estado puedes seleccionar cualquier rama existente para cambiar a ella. VS Code actualizará los archivos del proyecto al estado de esa rama de forma instantánea.": "From the same status bar menu, you can select any existing branch to switch to it. VS Code will instantly update the project files to that branch's state.",
  "La lista muestra todas las ramas locales; haz clic en una para cambiarte a ella": "The list shows all local branches; click one to switch to it",
  "Cuando tu funcionalidad esté lista y quieras incorporarla a main , sigue estos pasos dentro de VS Code:": "When your feature is ready and you want to merge it into main, follow these steps in VS Code:",
  "Cambia a la rama de destino ( main ) usando la barra de estado inferior.": "Switch to the target branch (main) using the bottom status bar.",
  "Abre la paleta de comandos con Ctrl+Shift+P y escribe Git: Merge Branch… .": "Open the command palette with Ctrl+Shift+P and type Git: Merge Branch….",
  "Selecciona la rama que quieres fusionar (p. ej., feature/formulario-contacto ).": "Select the branch you want to merge (for example, feature/contact-form).",
  "Si no hay conflictos, VS Code completará el merge automáticamente y los cambios quedarán integrados en main .": "If there are no conflicts, VS Code will complete the merge automatically and the changes will be integrated into main.",
  "Busca \"Git: Merge Branch\" en la paleta de comandos para iniciar la fusión": "Search for \"Git: Merge Branch\" in the command palette to start the merge",
  "Cuando se produce un conflicto, VS Code marca el archivo con una C roja en el explorador y en el panel Source Control. Al abrirlo, verás el código dividido en bloques con marcadores especiales:": "When a conflict occurs, VS Code marks the file with a red C in the explorer and in the Source Control panel. When you open it, you will see the code divided into blocks with special markers:",
  "<<<<<<< HEAD — inicio de tu versión (rama actual).": "<<<<<<< HEAD — start of your version (current branch).",
  ...
  "Accept Incoming Change — conserva únicamente la versión de la otra rama .": "Accept Incoming Change — keeps only the version from the other branch.",
  "Accept Both Changes — incluye las dos versiones, una detrás de la otra.": "Accept Both Changes — includes both versions, one after the other.",
  "Compare Changes — abre una vista de diferencias en dos paneles para decidir con más calma.": "Compare Changes — opens a two-panel diff view so you can decide more calmly.",
  "También puedes editar el archivo manualmente: simplemente borra los marcadores ( <<< , === , >>> ) y deja el código exactamente como quieres que quede.": "You can also edit the file manually: simply delete the markers (<<<, ===, >>>) and leave the code exactly as you want it.",
  "Una vez resueltos todos los conflictos del archivo, guárdalo ( Ctrl+S ). VS Code dejará de marcarlo con la C roja. Repite el proceso con cada archivo en conflicto y, cuando todos estén limpios, ve al panel Source Control y realiza un commit para cerrar el merge:": "Once all conflicts in the file are resolved, save it (Ctrl+S). VS Code will stop marking it with the red C. Repeat the process with each conflicted file and, when all are clean, go to the Source Control panel and make a commit to close the merge:",
  "Prepara los archivos resueltos con + .": "Stage the resolved files with +.",
  "Escribe un mensaje como Merge feature/formulario-contacto en main .": "Write a message such as Merge feature/contact-form into main.",
  ...
  "¡Repositorio creado! Ahora Git está vigilando esta carpeta.": "Repository created! Git is now watching this folder.",
  "2. Añadir archivos": "2. Add files",
  "Añade todos los archivos al staging": "Add all files to staging",
  "Archivos preparados para el commit (staging area).": "Files staged for the commit (staging area).",
  "3. Hacer commit": "3. Make a commit",
  "Crea un commit con el mensaje \"primer commit\"": "Create a commit with the message \"first commit\"",
  "¡Commit guardado! Tu código tiene su primera instantánea.": "Commit saved! Your code has its first snapshot.",
  "4. Crear rama": "4. Create branch",
  "Crea y cambia a una rama llamada \"feature/login\"": "Create and switch to a branch called \"feature/login\"",
  "¡Nueva rama creada! Ahora puedes trabajar de forma aislada.": "New branch created! Now you can work in isolation.",
  "5. Subir a GitHub": "5. Push to GitHub",
  "Sube la rama \"feature/login\" al remoto \"origin\"": "Push the \"feature/login\" branch to the \"origin\" remote",
  "🎉 ¡Reto completado! Tu rama ya está en GitHub.": "🎉 Challenge completed! Your branch is now on GitHub.",
  "🏆 ¡Todos los retos completados! Eres un pro de Git.": "🏆 All challenges completed! You are a Git pro.",
  "Bienvenido al simulador de Git": "Welcome to the Git simulator",
  "Completa los retos escribiendo los comandos correctos.": "Complete the challenges by typing the correct commands.",
  "Ya completaste todos los retos. ¡Recarga la página para volver a jugar!": "You already completed all challenges. Reload the page to play again!",
  "Comandos útiles: git init | git add . | git commit -m \"msg\" | git switch -c rama | git push origin rama": "Useful commands: git init | git add . | git commit -m \"msg\" | git switch -c branch | git push origin branch",
  "Este es un simulador de Git. Empieza tus comandos con \"git\" (o escribe \"help\").": "This is a Git simulator. Start your commands with \"git\" (or type \"help\").",
  "🏆 ¡FELICIDADES! Completaste todos los retos.": "🏆 CONGRATULATIONS! You completed all challenges.",
  "Ya sabes los comandos esenciales de Git. ¡A por el mundo!": "You now know the essential Git commands. Go conquer the world!",
  "Comando no reconocido en este contexto. Recuerda: ": "Command not recognized in this context. Remember: ",
  "Casi... revisa la sintaxis exacta del comando.": "Almost... check the exact syntax of the command.",
  "Piensa: ¿qué carpetas se generan automáticamente y nunca necesitas subir?": "Think: which folders are generated automatically and never need to be uploaded?",
  "node_modules/ y dist/ son carpetas que no se suben nunca al repositorio.": "node_modules/ and dist/ are folders that should never be uploaded to the repository.",
  "Los archivos .env contienen secretos. Los .log son ruido. .DS_Store es de macOS.": ".env files contain secrets. .log files are noise. .DS_Store is from macOS.",
  "Prueba con: node_modules/ · dist/ · .env · .env.local · *.log · .DS_Store": "Try: node_modules/ · dist/ · .env · .env.local · *.log · .DS_Store",
  "ignorado": "ignored",
  "pendiente": "pending",
  "trackeado": "tracked",
  "archivos ignorados correctamente": "files ignored correctly",
  "Ya has visto todas las pistas. ¡Inténtalo con lo que sabes!": "You have seen all the hints. Try it with what you know!",
  "✅ ¡Perfecto! Tu .gitignore es correcto. Todos los archivos sensibles están ignorados y el código fuente queda trackeado.": "✅ Perfect! Your .gitignore is correct. All sensitive files are ignored and the source code remains tracked.",
  "Aún faltan por ignorar:": "Still missing from ignore rules:",
  "Estás ignorando archivos que sí deberían subirse:": "You are ignoring files that should be uploaded:",
  "Crea una rama nueva": "Create a new branch",
  "Crea una rama llamada feature-titulo. En esa rama se cambiará el título de la página.": "Create a branch called feature-title. In that branch, the page title will be changed.",
  ...
  "Vuelve a la rama main. Allí también se cambiará la misma línea del archivo.": "Go back to the main branch. The same line in the file will also be changed there.",
  ...
  "Fusiona feature-titulo dentro de main. Como ambas ramas tocaron la misma línea, aparecerá un conflicto.": "Merge feature-title into main. Since both branches touched the same line, a conflict will appear.",
  "Usa: git merge feature-titulo": "Use: git merge feature-titulo",
  "Resuelve el archivo": "Resolve the file",
  "Edita index.html. Elimina los marcadores del conflicto y deja un único título que combine las dos ideas.": "Edit index.html. Remove the conflict markers and leave a single title that combines both ideas.",
  "Borra <<<<<<<, ======= y >>>>>>>. Quédate con un solo <h1> que incluya principiantes y ejercicios interactivos.": "Delete <<<<<<<, ======= and >>>>>>>. Keep a single <h1> that includes beginners and interactive exercises.",
  "Marca el conflicto como resuelto": "Mark the conflict as resolved",
  "Usa git add para decirle a Git que index.html ya está resuelto.": "Use git add to tell Git that index.html is already resolved.",
  "Usa: git add index.html": "Use: git add index.html",
  "Archivo preparado. Git ya sabe que el conflicto está resuelto.": "File staged. Git now knows the conflict is resolved.",
  "Finaliza el merge": "Finish the merge",
  "Haz un commit para cerrar el merge y guardar la resolución del conflicto.": "Make a commit to close the merge and save the conflict resolution.",
  "Usa: git commit -m \"resuelve conflicto en título\"": "Use: git commit -m \"resolve title conflict\"",
  ...
  "Este simulador solo acepta comandos de Git. Prueba con \"git status\".": "This simulator only accepts Git commands. Try \"git status\".",
  "❌ Escribe un comando que empiece por <code>git</code>.": "❌ Write a command that starts with <code>git</code>.",
  "El ejercicio ya está completado.": "The exercise is already completed.",
  "Ahora no toca escribir comandos. Primero resuelve el archivo en el editor.": "Now it is not time to type commands. First resolve the file in the editor.",
  "Comando incorrecto para este paso.": "Incorrect command for this step.",
  "❌ Ese comando no es el que toca ahora. Puedes escribir <code>git status</code> para orientarte.": "❌ That is not the command for this step. You can type <code>git status</code> to orient yourself.",
  "✅ Ejercicio completado. Has provocado un conflicto, lo has resuelto y has cerrado el merge.": "✅ Exercise completed. You triggered a conflict, resolved it and closed the merge.",
  "✅ Correcto. Continúa con el siguiente paso.": "✅ Correct. Continue with the next step.",
  "❌ Todavía quedan marcadores de conflicto. Elimina <code>&lt;&lt;&lt;&lt;&lt;&lt;&lt;</code>, <code>=======</code> y <code>&gt;&gt;&gt;&gt;&gt;&gt;&gt;</code>.": "❌ There are still conflict markers. Remove <code>&lt;&lt;&lt;&lt;&lt;&lt;&lt;</code>, <code>=======</code> and <code>&gt;&gt;&gt;&gt;&gt;&gt;&gt;</code>.",
  "❌ La solución debe conservar una línea <code>&lt;h1&gt;</code> relacionada con GitHub.": "❌ The solution must keep an <code>&lt;h1&gt;</code> line related to GitHub.",
  "⚠️ La idea es combinar las dos versiones: debe aparecer la idea de <strong>principiantes</strong> y la de <strong>ejercicios interactivos</strong>.": "⚠️ The idea is to combine both versions: the idea of <strong>beginners</strong> and <strong>interactive exercises</strong> must appear.",
  "index.html editado correctamente. El conflicto ya no tiene marcadores.": "index.html edited correctly. The conflict no longer has markers.",
  "✅ Resolución correcta. Ahora usa <code>git add index.html</code>.": "✅ Correct resolution. Now use <code>git add index.html</code>.",
  ...
  "Puedes escribir \"git status\" en cualquier momento para ver el estado.": "You can type \"git status\" at any time to see the status."
};
  Object.assign(STATIC_TRANSLATIONS, EXTRA_STATIC_TRANSLATIONS);
  const LAST_I18N_PATCH = {
  "1. Inicializar repo": "1. Initialize repo",
  "3. Hacer commit": "3. Make a commit",
  "Switched to a new branch 'feature-titulo'\n[feature-titulo a12b34c] Cambia título para principiantes": "Switched to a new branch 'feature-titulo'\n[feature-titulo a12b34c] Change title for beginners",
  "Switched to branch 'main'\n[main d45e67f] Añade ejercicios interactivos al título": "Switched to branch 'main'\n[main d45e67f] Add interactive exercises to the title",
  "[main f89a10b] Resuelve conflicto en título\nMerge finalizado correctamente.": "[main f89a10b] Resolve title conflict\nMerge completed successfully.",
  "Guía básica de GitHub": "Basic GitHub Guide",
  "Guía básica de GitHub con ejercicios interactivos": "Basic GitHub Guide with interactive exercises",
  ...
  "alt": {
    "Panel Source Control mostrando archivos modificados": "Source Control panel showing modified files",
    ...
    "Paleta de comandos con Git Merge Branch en VS Code": "Command palette with Git Merge Branch in VS Code",
    "Marcadores de conflicto en un archivo dentro de VS Code": "Conflict markers in a file inside VS Code",
    ".gitignore": ".gitignore"
  },
  "placeholder": {
    "escribe un comando git...": "write a git command...",
...
function isEligibleForGeneratedTranslation(el) {
  if (el.id === "lang-toggle-btn" || el.closest?.("#lang-toggle-btn")) return false;
  ...
  function setLanguage(lang) {
    ...
    document.querySelectorAll('[data-placeholder-es], [data-placeholder-en]').forEach((el) => setTranslatedAttribute(el, 'placeholder', lang));
...
function simUpdateHint() {
  ...
  if (simStep < SIM_CHALLENGES.length) {
    hint.textContent = uiText('💡 Pista: ', '💡 Hint: ') + uiTranslate(SIM_CHALLENGES[simStep].hint);
  } else {
...
function handleSimCommand(cmd) {
  if (simStep >= SIM_CHALLENGES.length) {
    simPrint(uiTranslate('Ya completaste todos los retos. ¡Recarga la página para volver a jugar!'), 'line-dim');
    return;
  }
  ...
  if (given === 'help' || given === 'git help') {
    simPrint(uiTranslate('Comandos útiles: git init | git add . | git commit -m "msg" | git switch -c rama | git push origin rama'), 'line-info');
    return;
  }
  ...
  if (!given.startsWith('git')) {
    simPrint(uiTranslate('Este es un simulador de Git. Empieza tus comandos con "git" (o escribe "help").'), 'line-err');
    return;
  }
  ...
  if (given === expected) {
    ...
    if (given.startsWith('git') && !given.includes(expected.split(' ')[1])) {
      simPrint(uiTranslate('Comando no reconocido en este contexto. Recuerda: ') + uiTranslate(challenge.hint), 'line-err');
    } else {
...
(function () {
  ...
  function renderFiles(rules) {
    ...
    if (lbl) lbl.textContent = currentLang === 'en' ? `${correct} of ${TOTAL} files ignored correctly` : `${correct} de ${TOTAL} archivos ignorados correctamente`;
  }
  ...
  window.giShowHint = () => {
    if (hintLevel >= HINTS.length) {
      showFeedback(uiTranslate("Ya has visto todas las pistas. ¡Inténtalo con lo que sabes!"), "info");
      return;
    }
  ...
  window.giCheckSolution = () => {
    ...
    if (missed.length === 0 && wrong.length === 0) {
      showFeedback(
        uiTranslate("✅ ¡Perfecto! Tu .gitignore es correcto. Todos los archivos sensibles están ignorados y el código fuente queda trackeado."),
        "ok"
      );
...
function cfRender() {
  ...
  if (label) {
    label.textContent = cfState.done
      ...
      : (currentLang === 'en' ? `Step ${cfState.step + 1} of ${CF_STEPS.length}` : `Paso ${cfState.step + 1} de ${CF_STEPS.length}`);
  }
...
function cfRunCommand(command) {
  ...
  if (!normalized.toLowerCase().startsWith("git")) {
    cfPrint(uiTranslate('Este simulador solo acepta comandos de Git. Prueba con "git status".'), "line-err");
    cfSetFeedback(uiTranslate("❌ Escribe un comando que empiece por <code>git</code>."), "err");
    return;
  }
  ...
  if (cfState.step === 3) {
    cfPrint(uiTranslate("Ahora no toca escribir comandos. Primero resuelve el archivo en el editor."), "line-err");
    return;
  }
  ...
  if (!isValid) {
    ...
    cfSetFeedback(
      uiTranslate('❌ Ese comando no es el que toca ahora. Puedes escribir <code>git status</code> para orientarte.'),
      "err"
    );
    return;
  }
  ...
  if (cfState.done) {
    cfSetFeedback(
      uiTranslate("✅ Ejercicio completado. Has provocado un conflicto, lo has resuelto y has cerrado el merge."),
      "ok"
    );
  } else {
    cfSetFeedback(uiTranslate("✅ Correcto. Continúa con el siguiente paso."), "ok");
  }
...
window.cfCheckResolution = function () {
  ...
  if (hasMarkers) {
    cfSetFeedback(
      uiTranslate("❌ Todavía quedan marcadores de conflicto. Elimina <code>&lt;&lt;&lt;&lt;&lt;&lt;&lt;</code>, <code>=======</code> y <code>&gt;&gt;&gt;&gt;&gt;&gt;&gt;</code>."),
      "err"
    );
    return;
  }
  ...
  if (!hasH1 || !hasGithub) {
    cfSetFeedback(
      uiTranslate("❌ La solución debe conservar una línea <code>&lt;h1&gt;</code> relacionada con GitHub."),
      "err"
    );
    return;
  }
  ...
  if (!hasBeginners || !hasExercises) {
    cfSetFeedback(
      uiTranslate("⚠️ La idea es combinar las dos versiones: debe aparecer la idea de <strong>principiantes</strong> y la de <strong>ejercicios interactivos</strong>."),
      "err"
    );
    return;
  }
  ...
  cfPrint(uiTranslate("index.html editado correctamente. El conflicto ya no tiene marcadores."), "line-ok");
  cfSetFeedback(uiTranslate("✅ Resolución correcta. Ahora usa <code>git add index.html</code>."), "ok");
  cfRender();
};
...
window.cfReset = function () {
  ...
  cfPrint(uiTranslate("Bienvenido al ejercicio de conflictos entre ramas."), "line-info");
  cfPrint(uiTranslate('Puedes escribir "git status" en cualquier momento para ver el estado.'), "line-dim");
